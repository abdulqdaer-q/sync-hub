create or replace function public.search_seniority_rank_v1(
  p_value text
)
returns integer
language sql
...
grant execute on function public.search_seniority_rank_v1(text) to authenticated;

drop function if exists public.search_candidates_v1(text, vector, integer, integer, text, text, numeric, text[], text, text, uuid[]);
